    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls textarea input-large">
                ...
                <input type="hidden" name="sn" value="<?php echo ((isset($info["sn"]) && ($info["sn"] !== ""))?($info["sn"]):''); ?>">
                <input type="hidden" name="time" value="<?php echo ((isset($info["time"]) && ($info["time"] !== ""))?($info["time"]):''); ?>">
                <input type="hidden" name="status" value="<?php echo ((isset($info["status"]) && ($info["status"] !== ""))?($info["status"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
