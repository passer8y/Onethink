...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Repair/add');?>">新 增</a>
            <button class="btn ajax-post confirm" url="<?php echo U('Repair/delete',array('method'=>'deleteUser'));?>" target-form="ids">删 除</button>
        </div>

        <!-- 高级搜索 -->
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="name" class="search-input" value="<?php echo I('name');?>" placeholder="请输入报修人姓名或者报修单号">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><span><?php echo (time_format($vo["time"])); ?></span></td>
			<td><?php echo ($vo["status"]); ?></td>
			<td>
				<!--<a class="btn btn-info ajax-get" href="<?php echo U('Repair/changeStatus?id='.$vo['id']);?>">接受处理</a>-->
				<a href="<?php echo U('Repair/edit?id='.$vo['id']);?>">查看</a>
				<a href="<?php echo U('Repair/delete?id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
            </td>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Repair/index');?>');
	</script>
